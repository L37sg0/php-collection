        ...
        <div class="row row-cols-2 row-cols-sm-3 row-cols-md-4 g-3">
            <div class="col">
                <div class="text-center py-2 px-2 border border-5 border-dark" style="color: darkorange;">
                    <h3><span class="text-dark">PRO</span>X<span class="text-dark">MO</span>X</h3>
                </div>
            </div>
            <div class="col">
                <div class="text-center py-2 px-2 border border-5 border-dark" style="color: blue">
                    <h3><span class="text-light rounded-3" style="background-color: blue">pf</span>sense</h3>
                </div>
            </div>
            <div class="col">
            ...
            <div class="col">
                <div class="text-center py-2 px-2 border border-5 border-dark" style="color: cornflowerblue">
                    <h3>My<span style="color: coral">SQL</span></h3>
                </div>
            </div>
            <div class="col">
