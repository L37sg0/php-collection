    ...
    <div
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <button type="button" class="btn btn-sm btn-outline-success m-1"
                    id="save_category">{{trans('Save')}}</button>
            @if(!empty($category))
...
@section('content_body')
    ...
    <div class="container">
        <form id="edit_category_form" method="POST"
              action="{{ !empty($category) ? route('admin.categories.update') : route('admin.categories.store') }}">
            @csrf
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="parent_id" name="parent_id">
                    ...
                    @foreach(Category::all() as $parentCategory)
                        <option
