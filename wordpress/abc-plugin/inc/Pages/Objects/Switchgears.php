...
class Switchgears extends TemplatesCallbacks
{
    public $table_name;
    public $data;
    ...
    {        
        ...
        $this->table_name = "abc_switchgears";
        $this->data = array(
            ...
            "outlet"        => $this->pageController->test_input($_POST["outlet"]),
        ...
        $this->outlets_names = [];
        $results = $this->dataApi->readTable("abc_outlets", array("id","name"));
        foreach($results as $result){
            $result = (array) $result;
            array_push( $this->outlets_names, $result["name"] );
        }
